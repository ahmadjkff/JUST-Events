...
function Dashboard() {
  ...
  const SYSTEM_SUMMARY = [
    {
      title: "Created Events by Me",
      subtitle: counts.myEvents,
      icon: User,
      description: "Events created and managed by you.",
      color: "orange",
    },
    {
      ...
      icon: CalendarCheck,
      description: "Events approved by the admin.",
      color: "green",
    },
    {
      ...
      icon: Clock,
      description: "Events awaiting admin approval.",
      color: "yellow",
    },
    {
      ...
      icon: XCircle,
      description: "Events rejected by the admin.",
      color: "red",
    },
  ];
  ...
  const DASHBOARD_ITEMS = [
    {
      title: "Control Student Applications",
      icon: Calendar,
      description:
        "Edit or delete events, approve/reject students, and export registered students.",
      onClick: () => {
  ...
  return (
    <div className="p-8">
      <header className="mb-8">
        <h1 className="text-4xl font-extrabold">Supervisor Dashboard</h1>
        <p className="text-muted-foreground">
          Manage your events and student applications efficiently
        </p>
      </header>
