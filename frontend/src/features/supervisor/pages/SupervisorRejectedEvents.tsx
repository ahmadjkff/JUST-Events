...
function SupervisorRejectedEvents() {
  ...
  const handleDeleteEvent = async (eventId: string) => {
    try {
      ...
      if (result.success) {
        await fetchSupervisorApplications("rejected");
      } else {
  ...
  useEffect(() => {
    fetchSupervisorApplications("rejected");
  }, []);
...
export default SupervisorRejectedEvents;
