...
import StudentSidebar from "../../../components/studentComponents/student-sidebar"
import StudentDashboardCards from "../../../components/studentComponents/student-dashboard-cards"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h2 className="text-xl font-semibold mb-2">
                      Welcome to Jordan University of Science and Technology Events Platform
                    </h2>
                    <p className="text-muted-foreground">
